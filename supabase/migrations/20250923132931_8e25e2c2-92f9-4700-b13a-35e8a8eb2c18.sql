...
-- Create unique constraints for likes
CREATE UNIQUE INDEX likes_story_unique ON public.likes (user_id, story_id) WHERE chapter_id IS NULL;
CREATE UNIQUE INDEX likes_chapter_unique ON public.likes (user_id, chapter_id) WHERE story_id IS NULL;
