      ...
      {stories.length > 0 && (
        <section className="py-12 sm:py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 sm:gap-6 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6">
              {stories.slice(0, 8).map((story) => (
                <Card key={story.id} className="vine-card hover:shadow-lg transition-all duration-300 cursor-pointer group">
                  <CardContent className="p-4 h-full flex flex-col">
                    ...
                    <h3 className="font-semibold text-sm sm:text-base mb-2 line-clamp-2 flex-1">{story.title}</h3>
